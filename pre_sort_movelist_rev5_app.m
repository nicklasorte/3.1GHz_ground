function [move_list_turn_off_idx,sort_sim_array_list_bs,sort_bs_idx,array_bs_azi_data,sort_full_Pr_dBm,sorted_array_fed_azi_data,sorted_array_mc_pr_dbm]=pre_sort_movelist_rev5_app(app,move_list_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,radar_threshold,mc_percentile,sim_array_list_bs,data_label1,reliability,norm_aas_zero_elevation_data)
...
sort_bs_idx_file_name=strcat(data_label1,'_sort_bs_idx_',num2str(point_idx),'.mat');
sort_sim_array_file_name=strcat(data_label1,'_sort_sim_array_list_bs_',num2str(point_idx),'.mat');
sort_Pr_dBm_file_name=strcat(data_label1,'_sort_full_Pr_dBm_',num2str(point_idx),'.mat');
sort_bs_azi_data_file_name=strcat(data_label1,'_array_bs_azi_data_',num2str(point_idx),'.mat');
sorted_array_fed_azi_data_file_name=strcat(data_label1,'_sorted_array_fed_azi_data_',num2str(point_idx),'.mat');
sorted_array_mc_pr_dbm_file_name=strcat(data_label1,'_sorted_array_mc_pr_dbm_data_',num2str(point_idx),'.mat');
...
if var_exist_movelist==2 && var_exist_sort_idx==2 && var_exist_sim_array==2 && var_exist_PrdBm==2 && var_exist_bs_azi==2 && var_exist_fed_azi==2 && var_exist_mc_pr_dbm==2
    ...
    ITM_Pathloss=ITM_Pathloss(:,[rel_first_idx:rel_second_idx]);
    ...
    mid_pathloss_dB=ITM_Pathloss(:,mid_idx);
...
% % % % %     toc; %%%%%Elapsed time is 0.000862 seconds.
    ...
    sort_full_Pr_dBm=sim_array_list_bs(sort_bs_idx,4)-ITM_Pathloss(sort_bs_idx,:)+bs_azi_gain(sort_bs_idx); %%%%%%%%%%%Non-Mitigation EIRP - Pathloss + BS Azi Gain = Power Received at Federal System
