function [move_list_turn_off_idx,sort_sim_array_list_bs,sort_bs_idx,array_bs_azi_data,sort_full_Pr_dBm,sorted_array_fed_azi_data,sorted_array_mc_pr_dbm]=pre_sort_movelist_rev6_string_prop_model_app(app,move_list_reliability,point_idx,sim_number,mc_size,radar_beamwidth,base_protection_pts,min_ant_loss,radar_threshold,mc_percentile,sim_array_list_bs,data_label1,reliability,norm_aas_zero_elevation_data,string_prop_model)
...
%%%%%%%%%%%%%%%%%%%movelist_file_name=strcat('move_list_turn_off_idx_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'.mat');
movelist_file_name=strcat(string_prop_model,'_move_list_turn_off_idx_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'.mat');
...
sort_bs_idx_file_name=strcat(data_label1,'_',string_prop_model,'_sort_bs_idx_',num2str(point_idx),'.mat');
sort_sim_array_file_name=strcat(data_label1,'_',string_prop_model,'_sort_sim_array_list_bs_',num2str(point_idx),'.mat');
sort_Pr_dBm_file_name=strcat(data_label1,'_',string_prop_model,'_sort_full_Pr_dBm_',num2str(point_idx),'.mat');
sort_bs_azi_data_file_name=strcat(data_label1,'_',string_prop_model,'_array_bs_azi_data_',num2str(point_idx),'.mat');
sorted_array_fed_azi_data_file_name=strcat(data_label1,'_',string_prop_model,'_sorted_array_fed_azi_data_',num2str(point_idx),'.mat');
sorted_array_mc_pr_dbm_file_name=strcat(data_label1,'_',string_prop_model,'_sorted_array_mc_pr_dbm_data_',num2str(point_idx),'.mat');


[var_exist_movelist]=persistent_var_exist(app,movelist_file_name);
[var_exist_sort_idx]=persistent_var_exist(app,sort_bs_idx_file_name);
[var_exist_sim_array]=persistent_var_exist(app,sort_sim_array_file_name);
[var_exist_PrdBm]=persistent_var_exist(app,sort_Pr_dBm_file_name);
[var_exist_bs_azi]=persistent_var_exist(app,sort_bs_azi_data_file_name);
[var_exist_fed_azi]=persistent_var_exist(app,sorted_array_fed_azi_data_file_name);
[var_exist_mc_pr_dbm]=persistent_var_exist(app,sorted_array_mc_pr_dbm_file_name);

if var_exist_movelist==2 && var_exist_sort_idx==2 && var_exist_sim_array==2 && var_exist_PrdBm==2 && var_exist_bs_azi==2 && var_exist_fed_azi==2 && var_exist_mc_pr_dbm==2
    %%%%%%%%%%%load
    retry_load=1;
    while(retry_load==1)
        try
