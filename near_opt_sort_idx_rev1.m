function [opt_sort_bs_idx]=near_opt_sort_idx_rev1(app,data_label1,point_idx,tf_calc_opt_sort,radar_beamwidth,min_ant_loss,sim_array_list_bs,base_protection_pts,temp_pr_dbm)
        ...
        opt_sort_bs_idx_file_name=strcat(data_label1,'_opt_sort_bs_idx_',num2str(point_idx),'.mat');
        [var_exist_opt_sort]=persistent_var_exist(app,opt_sort_bs_idx_file_name);
