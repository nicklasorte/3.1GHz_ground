...
off_list_bs_file_name=strcat('off_list_bs_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'.mat');
mitigation_list_bs_file_name=strcat('mitigation_list_bs_',num2str(min(move_list_reliability)),'_',num2str(max(move_list_reliability)),'_',num2str(point_idx),'_',num2str(sim_number),'_',num2str(mc_size),'.mat');
...
mitigation_sort_bs_idx_file_name=strcat(data_label1,'_mitigation_sort_bs_idx_',num2str(point_idx),'.mat');
mitigation_sort_sim_array_file_name=strcat(data_label1,'_mitigation_sort_sim_array_list_bs_',num2str(point_idx),'.mat');
...
% %     end
    ...
    sort_full_Pr_dBm=sim_array_list_bs(mitigation_sort_bs_idx,4)-ITM_Pathloss(mitigation_sort_bs_idx,:)+bs_azi_gain(mitigation_sort_bs_idx);
    mitigation_sort_sim_array_list_bs=sim_array_list_bs(mitigation_sort_bs_idx,:);
    mitigation_sort_full_Pr_dBm=sim_array_list_bs(mitigation_sort_bs_idx,8)-ITM_Pathloss(mitigation_sort_bs_idx,:)+bs_azi_gain(mitigation_sort_bs_idx);
